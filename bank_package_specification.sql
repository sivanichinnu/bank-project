CREATE OR REPLACE PACKAGE HDFC_BANK IS
...
(P_CUST_ID  BANK_CUST_CONTACT.CUST_ID%TYPE,
 ...
 PROCEDURE PNAME_DEL_CUST(P_BANK_CUST_ID BANK_CUST.CUST_ID%TYPE);
 PROCEDURE PNAME_DEL_CUST(P_CUST_FIRST_NAME BANK_CUST.CUST_FIRST_NAME%TYPE);
